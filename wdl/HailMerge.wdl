...
try:
  print(os.popen("hailctl dataproc start --num-workers 8 --region {} --project {} --num-master-local-ssds 1 --num-worker-local-ssds 1 --max-idle=60m --max-age=1440m {}".format("~{region}", "~{gcs_project}", cluster_name)).read())
